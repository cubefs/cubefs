		...
		for _, scanner := range l.lcScanners {
			result := &proto.LcNodeRuleTaskResponse{
				...
				LcNodeRuleTaskStatistics: proto.LcNodeRuleTaskStatistics{
					...
					ExpiredMNum:              atomic.LoadInt64(&scanner.currentStat.ExpiredMNum),
					ExpiredMBytes:            atomic.LoadInt64(&scanner.currentStat.ExpiredMBytes),
					...
					ErrorMNum:                atomic.LoadInt64(&scanner.currentStat.ErrorMNum),
