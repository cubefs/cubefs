...
func TestNewFlashGroup(t *testing.T) {
	...
	fg := newFlashGroup(id, slots, slotStatus, pendingSlots, step, status, weight, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_GetAdminView(t *testing.T) {
	fg := newFlashGroup(1, []uint32{1, 2, 3}, proto.SlotStatus_Completed, []uint32{}, 3,
		proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)

	// Add some flash nodes
	fn1 := &FlashNode{FlashNodeValue: FlashNodeValue{Addr: "node1", ZoneName: "zone1", Region: proto.DefaultRegion}}
	fn2 := &FlashNode{FlashNodeValue: FlashNodeValue{Addr: "node2", ZoneName: "zone2", Region: proto.DefaultRegion}}
	fg.putFlashNode(fn1)
	fg.putFlashNode(fn2)
...
func TestFlashGroup_ReduceSlot_AlreadyReducing(t *testing.T) {
	fg := newFlashGroup(1, []uint32{1, 2, 3, 4, 5, 6, 7, 8}, proto.SlotStatus_Completed, []uint32{},
		8, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_IsLostAllFlashNode(t *testing.T) {
	fg := newFlashGroup(1, []uint32{1, 2, 3}, proto.SlotStatus_Completed, []uint32{}, 3, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_getSlots(t *testing.T) {
	...
	fg := newFlashGroup(1, initialSlots, proto.SlotStatus_Completed, []uint32{}, 5, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_getSlotStatus(t *testing.T) {
	fg := newFlashGroup(1, []uint32{1, 2, 3}, proto.SlotStatus_Creating, []uint32{}, 3, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_getFlashNodesCount(t *testing.T) {
	...
	// Add a flash node
	fn := &FlashNode{FlashNodeValue: FlashNodeValue{Addr: "node1", ZoneName: "zone1", Region: proto.DefaultRegion}}
	fg.putFlashNode(fn)
...
func TestFlashGroup_getSlotsCount(t *testing.T) {
	fg := newFlashGroup(1, []uint32{1, 2, 3, 4, 5}, proto.SlotStatus_Completed, []uint32{}, 5, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_GetPendingSlotsCount(t *testing.T) {
	...
	fg := newFlashGroup(1, []uint32{4, 5, 6}, proto.SlotStatus_Completed, pendingSlots, 3, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_ConcurrentAccess(t *testing.T) {
	fg := newFlashGroup(1, []uint32{1, 2, 3, 4, 5, 6, 7, 8}, proto.SlotStatus_Completed, []uint32{}, 8, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_IncreaseSlot_WithReservedSlots(t *testing.T) {
	...
	fg := newFlashGroup(1, initialSlots, proto.SlotStatus_Completed, []uint32{}, 3, proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
...
func TestFlashGroup_IncreaseSlot_StepCalculation(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			fg := newFlashGroup(1, tc.slots, proto.SlotStatus_Completed, []uint32{}, uint32(len(tc.slots)), proto.FlashGroupStatus_Active, 100, proto.DefaultTopoName, proto.DefaultRegion)
