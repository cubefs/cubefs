...
build_client() {
    ...
    gcc ${gccflag} -std=c99 -fPIC -shared -o ${BuildBinPath}/libcfsclient.so ${SrcPath}/client/main_hook.c -ldl -lpthread -I ${SrcPath}/client/bypass/include || "failed"
    echo -n "libcfsc.so   "
    g++ -std=c++11 ${gccflag} -DCommitID=\"${CommitID}\" -fPIC -shared -o ${BuildBinPath}/libcfsc.so ${SrcPath}/client/bypass/client.c ${SrcPath}/client/bypass/cache.c ${SrcPath}/client/bypass/packet.c ${SrcPath}/client/bypass/conn_pool.c ${SrcPath}/client/bypass/ini.c -ldl -lpthread -I ${SrcPath}/client/bypass/include || "failed"
    echo -n "libcfssdk.so   "
