...
var (
	...
	ErrBodyReadTimeout = errors.New("read body timeout")
)
...
func WithCrcEncode() Option {
	return func(req *http.Request) {
		...
		if req.ContentLength > 0 {
			req.ContentLength = crc32block.EncodeSizeWithDefualtBlock(req.ContentLength)
		}
		// util not support reader = nil
		if req.Body != nil {
			enc := crc32block.NewEncoderReader(req.Body)
			req.Body = readCloser{enc, req.Body}
		}
	}
}
