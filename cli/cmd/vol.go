...
func newVolCreateCmd(client *master.MasterClient) *cobra.Command {
	...
	cmd.Flags().BoolVar(&optFollowerRead, CliFlagEnableFollowerRead, cmdVolDefaultFollowerReader, "Enable read from replica raft follower")
...
func newVolSetCmd(client *master.MasterClient) *cobra.Command {
	...
	cmd.Flags().StringVar(&optFollowerRead, CliFlagEnableFollowerRead, "", "Enable read from replica raft follower")
