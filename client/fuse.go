...
func parseMountOption(cfg *config.Config) (*proto.MountOptions, error) {
	...
	opt.EnableRDMA = GlobalMountOptions[proto.EnableRDMA].GetBool()
	opt.RDMANumSlots = GlobalMountOptions[proto.RDMANumSlots].GetInt64()
	opt.RDMASlotSize = GlobalMountOptions[proto.RDMASlotSize].GetInt64()
	opt.RDMABusySpinCount = GlobalMountOptions[proto.RDMABusySpinCount].GetInt64()
	opt.RDMAYieldCount = GlobalMountOptions[proto.RDMAYieldCount].GetInt64()
	...
	opt.RDMAReadSlotCount = GlobalMountOptions[proto.RDMAReadSlotCount].GetInt64()
	opt.RDMAReadSlotSize = GlobalMountOptions[proto.RDMAReadSlotSize].GetInt64()
	opt.RDMAOneSidedReadDisabled = GlobalMountOptions[proto.RDMAOneSidedReadDisabled].GetBool()
	opt.RDMAReadTimeoutMs = GlobalMountOptions[proto.RDMAReadTimeoutMs].GetInt64()
	opt.RDMAReadPrefetchDepth = GlobalMountOptions[proto.RDMAReadPrefetchDepth].GetInt64()
