...
func (m *MockGroup) MemberChange(arg0 context.Context, arg1 *raft.Member) error {
	m.ctrl.T.Helper()
...
func (m *MockGroup) Propose(arg0 context.Context, arg1 *raft.ProposalData) (raft.ProposalResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Propose", arg0, arg1)
	ret0, _ := ret[0].(raft.ProposalResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGroup) Stat() (*raft.Stat, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Stat")
	ret0, _ := ret[0].(*raft.Stat)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
