...
//go:generate mockgen -source=../../shardnode/blobdeleter/blob_deleter.go -destination=./blob_deleter.go -package=mock -mock_names ShardGetter=MockMessageMgrShardGetter,MessageExecutor=MockMessageExecutorMgr
