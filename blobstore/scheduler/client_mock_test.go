...
// Source: github.com/cubefs/cubefs/blobstore/scheduler/client (interfaces: ClusterMgrAPI,BlobnodeAPI,IVolumeUpdater)
...
// ListSealedVolume mocks base method.
func (m *MockClusterMgrAPI) ListSealedVolume(arg0 context.Context) ([]*client.VolumeInfoSimple, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListSealedVolume", arg0)
	ret0, _ := ret[0].([]*client.VolumeInfoSimple)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListSealedVolume indicates an expected call of ListSealedVolume.
func (mr *MockClusterMgrAPIMockRecorder) ListSealedVolume(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSealedVolume", reflect.TypeOf((*MockClusterMgrAPI)(nil).ListSealedVolume), arg0)
}
...
func (m *MockClusterMgrAPI) SetVolumeIdle(arg0 context.Context, arg1 proto.Vid) error {
	m.ctrl.T.Helper()
...
func (mr *MockClusterMgrAPIMockRecorder) SetVolumeIdle(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetVolumeIdle", reflect.TypeOf((*MockClusterMgrAPI)(nil).SetVolumeIdle), arg0, arg1)
}
...
func (m *MockClusterMgrAPI) SetVolumeSealed(arg0 context.Context, arg1 proto.Vid) error {
	m.ctrl.T.Helper()
...
func (mr *MockClusterMgrAPIMockRecorder) SetVolumeSealed(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetVolumeSealed", reflect.TypeOf((*MockClusterMgrAPI)(nil).SetVolumeSealed), arg0, arg1)
}
