...
// Source: github.com/cubefs/cubefs/blobstore/scheduler (interfaces: ITaskRunner,IVolumeCache,MMigrator,IVolumeInspector,IClusterTopology,ShardDiskMigrator,DiskGetter)
...
// MockDiskGetter is a mock of DiskGetter interface.
type MockDiskGetter struct {
	ctrl     *gomock.Controller
	recorder *MockDiskGetterMockRecorder
}

// MockDiskGetterMockRecorder is the mock recorder for MockDiskGetter.
type MockDiskGetterMockRecorder struct {
	mock *MockDiskGetter
}

// NewMockDiskGetter creates a new mock instance.
func NewMockDiskGetter(ctrl *gomock.Controller) *MockDiskGetter {
	mock := &MockDiskGetter{ctrl: ctrl}
	mock.recorder = &MockDiskGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockDiskGetter) EXPECT() *MockDiskGetterMockRecorder {
	return m.recorder
}

// GetDisk mocks base method.
func (m *MockDiskGetter) GetDisk(arg0 proto.DiskID) (*client.DiskInfoSimple, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDisk", arg0)
	ret0, _ := ret[0].(*client.DiskInfoSimple)
	ret1, _ := ret[1].(bool)
...
// GetDisk indicates an expected call of GetDisk.
func (mr *MockDiskGetterMockRecorder) GetDisk(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDisk", reflect.TypeOf((*MockDiskGetter)(nil).GetDisk), arg0)
}
