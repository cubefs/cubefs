...
const (
	FormatMetaTypeV1       = "fs"
	FormatMetaTypeV2       = "raw-device-v1"
...
type FormatInfoProtectedField struct {
	...
	// FormatParams hold format parameters for different disk format meta type
...
func (fi *FormatInfo) Marshal() ([]byte, error) {
	return json.Marshal(fi)
}

func (fi *FormatInfo) Unmarshal(b []byte) error {
