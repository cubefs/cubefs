...
import (
	...
	client "github.com/cubefs/cubefs/blobstore/blobnode/client"
...
func (m *MockIShardNode) LeaderTransfer(arg0 context.Context, arg1 *client.LeaderTransferArgs) error {
	m.ctrl.T.Helper()
...
func (mr *MockIShardNodeMockRecorder) LeaderTransfer(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LeaderTransfer", reflect.TypeOf((*MockIShardNode)(nil).LeaderTransfer), arg0, arg1)
}
