...
// WaitDone mocks base method.
func (m *MockIoPool) WaitDone(arg0 func()) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "WaitDone", arg0)
}

// WaitDone indicates an expected call of WaitDone.
func (mr *MockIoPoolMockRecorder) WaitDone(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WaitDone", reflect.TypeOf((*MockIoPool)(nil).WaitDone), arg0)
}
