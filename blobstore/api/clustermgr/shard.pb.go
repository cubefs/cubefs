...
type AllocShardUnitArgs struct {
	Suid                 github_com_cubefs_cubefs_blobstore_common_proto.Suid     `protobuf:"varint,1,opt,name=suid,proto3,casttype=github.com/cubefs/cubefs/blobstore/common/proto.Suid" json:"suid,omitempty"`
	ExcludeDiskIDs       []github_com_cubefs_cubefs_blobstore_common_proto.DiskID `protobuf:"varint,2,rep,packed,name=exclude_disk_ids,json=excludeDiskIds,proto3,casttype=github.com/cubefs/cubefs/blobstore/common/proto.DiskID" json:"exclude_disk_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                                 `json:"-"`
	XXX_unrecognized     []byte                                                   `json:"-"`
	XXX_sizecache        int32                                                    `json:"-"`
}
...
func (m *AllocShardUnitArgs) GetExcludeDiskIDs() []github_com_cubefs_cubefs_blobstore_common_proto.DiskID {
	if m != nil {
		return m.ExcludeDiskIDs
	}
	return nil
}
...
var fileDescriptor_319ea41e44cdc364 = []byte{
	...
	,
}
...
func (this *AllocShardUnitArgs) GoString() string {
	...
	s = append(s, "Suid: "+fmt.Sprintf("%#v", this.Suid)+",\n")
	s = append(s, "ExcludeDiskIDs: "+fmt.Sprintf("%#v", this.ExcludeDiskIDs)+",\n")
	if this.XXX_unrecognized != nil {
		s = append(s, "XXX_unrecognized:"+fmt.Sprintf("%#v", this.XXX_unrecognized)+",\n")
	}
	s = append(s, "}")
...
func (m *AllocShardUnitArgs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExcludeDiskIDs) > 0 {
		dAtA4 := make([]byte, len(m.ExcludeDiskIDs)*10)
		var j3 int
		for _, num := range m.ExcludeDiskIDs {
			for num >= 1<<7 {
		...
		i = encodeVarintShard(dAtA, i, uint64(j3))
		i--
		dAtA[i] = 0x12
	}
	if m.Suid != 0 {
...
func (m *AllocShardUnitArgs) Size() (n int) {
	...
	if len(m.ExcludeDiskIDs) > 0 {
		l = 0
		for _, e := range m.ExcludeDiskIDs {
			l += sovShard(uint64(e))
		}
...
func (this *AllocShardUnitArgs) String() string {
	...
	s := strings.Join([]string{`&AllocShardUnitArgs{`,
		`Suid:` + fmt.Sprintf("%v", this.Suid) + `,`,
		`ExcludeDiskIDs:` + fmt.Sprintf("%v", this.ExcludeDiskIDs) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
		`}`,
	}, "")
	return s
...
func (m *AllocShardUnitArgs) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType == 0 {
				var v github_com_cubefs_cubefs_blobstore_common_proto.DiskID
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowShard
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= github_com_cubefs_cubefs_blobstore_common_proto.DiskID(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				m.ExcludeDiskIDs = append(m.ExcludeDiskIDs, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.ExcludeDiskIDs) == 0 {
					m.ExcludeDiskIDs = make([]github_com_cubefs_cubefs_blobstore_common_proto.DiskID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_cubefs_cubefs_blobstore_common_proto.DiskID
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field ExcludeDiskIDs", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipShard(dAtA[iNdEx:])
