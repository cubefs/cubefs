...
func (loc *LocInfo) ExtractBlobLocation() (access.Location, error) {
	if loc == nil || loc.Value == nil {
		return access.Location{}, fmt.Errorf("loc is nil")
	}
	...
	case access.Location:
		return v, nil
	default:
		return access.Location{}, fmt.Errorf("loc type error: %T", v)
	}
}
