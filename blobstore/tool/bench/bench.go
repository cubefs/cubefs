...
import (
	...
	ls "github.com/cubefs/cubefs/blobstore/tool/bench/location"
)
...
`
	...
	if s, err := bytefmt.ToBytes(objSize); err != nil {
...
func prepareData() {
	...
	log.Printf("data MD5=%s", objectDataMD5)
}
