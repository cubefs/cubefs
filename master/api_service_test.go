...
func TestCreateVolForUpdateToCrossRegionVol(t *testing.T) {
	...
	err := mc.AdminAPI().CreateVolume(volName, "cfs", 3, 120, 200, 3, 3, 0, 1,
		false, false, false, true, false, false, false, zoneName, "0,0", "", 0, "default", defaultEcDataNum, defaultEcParityNum, false, 0, 0, 0, false)
	if err != nil {
...
func TestUpdateVolToCrossRegionVol(t *testing.T) {
	...
	err := mc.AdminAPI().UpdateVolume(volName, 200, 5, 0, 0, 1, false, false, false, false, false, false,
		true, false, false, false, buildAuthKey("cfs"), newZoneName, "0,0", "", 0, 1, 120, "default", 0, 0, 0, 0, 0, exporter.UMPCollectMethodUnknown, -1, -1, false)
	if err != nil {
...
func TestSmartVolRules(t *testing.T) {
	...
	err = mc.AdminAPI().CreateVolume(volName, "cfs", 3, 120, 200, 3, 3, 3, int(proto.StoreModeMem),
		false, false, false, true, true, false, false, testZone2, "", testSmartRules, 0, "default", defaultEcDataNum, defaultEcParityNum, false, 0, 0, 0, false)
	if err != nil {
		t.Errorf("CreateVolume err:%v", err)
		return
	}
