...
func (s *VolumeService) updateVolume(ctx context.Context, args struct {
	...
	if err = s.cluster.updateVol(args.Name, args.AuthKey, *args.ZoneName, *args.Description, *args.Capacity,
		...
		*args.batchDelInodeCnt, *args.delInodeInterval, vol.UmpCollectWay, vol.TrashCleanMaxCountEachTime, vol.CleanTrashDurationEachTime, false, proto.DefaultSkipStepOnLeaderChange); err != nil {
		return nil, err
	}
