...
func (c *Cluster) allDataNodes() (dataNodes []proto.NodeView) {
	...
	c.dataNodes.Range(func(addr, node interface{}) bool {
		dataNode := node.(*DataNode)
		dataNodes = append(dataNodes, proto.NodeView{Addr: dataNode.Addr, Active: dataNode.isActive, ID: dataNode.ID, IsWritable: dataNode.isWriteAble()})
		return true
	})
	return
}
...
func (c *Cluster) allMetaNodes() (metaNodes []proto.NodeView) {
	...
	c.metaNodes.Range(func(addr, node interface{}) bool {
		...
		metaNodes = append(metaNodes, proto.NodeView{ID: metaNode.ID, Addr: metaNode.Addr, Active: metaNode.IsActive, IsWritable: metaNode.isWritable()})
		return true
	})
	return
}
