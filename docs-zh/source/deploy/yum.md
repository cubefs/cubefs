...
``` bash
$ wget https://ocs-cn-north1.heytapcs.com/cubefs/rpm/3.4.0-rdma/cfs-install-rdma-beta-3.4.0-el7.x86_64.rpm
$ yum install -y cfs-install-rdma-beta-3.4.0-el7.x86_64.rpm
$ cd /cfs/install
$ tree -L 3
 .
 ├── install_cfs.yml
