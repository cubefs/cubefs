...
| disk_punish_threshold    | 磁盘惩罚阈值                 | 否，默认 3                      |
| disk_punish_valid_interval_s | 磁盘惩罚恢复间隔         | 否，默认 30s                    |
| disk_memory_expiration_s | 磁盘过期时间                 | 否，默认 0 (no expiration)      |
| service_punish_threshold | 服务惩罚阈值                 | 否，默认 3                      |
| service_punish_valid_interval_s | 服务惩罚阈值          | 否，默认 30s                    |
