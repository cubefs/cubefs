...
//function begin .....
func (c *VolumeClient) CreateVolume(ctx context.Context, authenticate bool, capacity uint64, crossZone bool, dataPartitionSize uint64, description string, dpReplicaNum uint64, storeType uint8, enableToken bool, followerRead bool, mpCount uint64, name string, owner string, zoneName string) (*Vol, error) {

	req := client.NewRequest(ctx, `mutation($authenticate: bool, $capacity: uint64, storeType: uint8, $crossZone: bool, $dataPartitionSize: uint64, $description: string, $dpReplicaNum: uint64, $enableToken: bool, $followerRead: bool, $mpCount: uint64, $name: string, $owner: string, $zoneName: string){
createVolume(authenticate: $authenticate, capacity: $capacity, storeType: $storeType, crossZone: $crossZone, dataPartitionSize: $dataPartitionSize, description: $description, dpReplicaNum: $dpReplicaNum, enableToken: $enableToken, followerRead: $followerRead, mpCount: $mpCount, name: $name, owner: $owner, zoneName: $zoneName){
				capacity
				createTime
				dpReplicaNum
				followerRead
