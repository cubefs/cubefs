...
func TestVolCreate(t *testing.T) {
	...
	err := testMc.AdminAPI().CreateVolume(testVolName, testOwner, testMpcount, testDpSize, testCapacity,
		testReplicas, testMpReplicas, testTrashDays, testStoreMode, testFollowerRead, testAutoRepair, testVolWriteMutex, testForceROW, testIsSmart, testEnableWriteCache, false, testZoneName, testMpLyout, "", 0, proto.CompactDefaultName, 4, 2, false, 0, 0, 0)
	if err != nil {
