...
func TestUserAPI(t *testing.T) {
	...
	err = testMc.AdminAPI().CreateVolume(testTransVol, testOwner, testMpcount, testDpSize, testCapacity, testReplicas, testFollowerRead, testAutoRepair, testVolWriteMutex, testZoneName)
	if err != nil {
