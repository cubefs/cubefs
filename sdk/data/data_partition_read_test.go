...
func TestLeaderRead(t *testing.T) {
	...
	if err = testMc.AdminAPI().UpdateVolume("ltptest", 30, 3, false, false, false, false, calcAuthKey("ltptest"), "default"); err != nil {
	...
	if err = testMc.AdminAPI().UpdateVolume("ltptest", 30, 3, true, false, false, false, calcAuthKey("ltptest"), "default"); err != nil {
