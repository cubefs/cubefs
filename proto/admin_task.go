...
func (t *AdminTask) IsHeartbeatTask() bool {
	return t.OpCode == OpDataNodeHeartbeat || t.OpCode == OpMetaNodeHeartbeat || t.OpCode == OpLcNodeHeartbeat || t.OpCode == OpFlashNodeHeartbeat || t.OpCode == OpSyncNodeHeartbeat
}
