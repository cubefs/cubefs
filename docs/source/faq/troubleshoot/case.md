...
## Question 32
_Description_： Does cubefs is working properly in arm environment?

**Answer**：No problem.

## Question 33
_Description_：Can metadata be deployed partitioned? Won't stress be put on the main raft process?

**Answer**： Yes. It's multi raft.
...
**Answer**：Volumes were created without erasure codes.
...
**Answer**：The master starts before the datanode and metanode.
