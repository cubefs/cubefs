...
``` bash
# x86 version
$ yum install https://cubefs-rs.heytapdownload.com/rpm/3.5.3/cfs-install-3.5.3-el7.x86_64.rpm
# arm version
$ yum install https://cubefs-rs.heytapdownload.com/rpm/3.5.3/cfs-install-3.5.3-el7.aarch64.rpm
$ cd /cfs/install
$ tree -L 3
 .
 ├── install_cfs.yml
